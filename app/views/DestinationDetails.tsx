  ...
  const getTransportIcon = (
    ...
    switch (type) {
      ...
      case TransportTypes.Plane:
        return status === 'arrival' ? 'airplane.arrival' : 'airplane.departure';
    }
  };
    ...
    >
      <ThemedView background style={styles.body}>
        ...
        {arrival && (
          <CardView style={styles.card}>
            <ThemedView style={styles.iconTitle}>
              <Icon name={getTransportIcon(arrival.type, 'arrival')} />
        ...
        {departure && (
          <CardView style={styles.card}>
            <ThemedView style={styles.iconTitle}>
              <Icon name={getTransportIcon(departure.type, 'departure')} />
        ...
        {weather && (
          <CardView style={styles.card}>
            <ThemedView style={styles.iconTitle}>
              <Icon name="sun.and.horizon.fill" />
